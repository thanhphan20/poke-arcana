...
async function main() {
  ...
  console.log(`[Production] Fetching Pokemon #${DEX_START}-${DEX_END} from ${BASE_URL} ...`);
  ...
  console.log('✓ Skipped image downloads (production mode)');
}

main().catch((err) => {
  console.error('\n[Error] Sync failed — pokemon.json was NOT overwritten.');
